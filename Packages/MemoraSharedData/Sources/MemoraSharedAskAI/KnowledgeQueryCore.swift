...
@MainActor
public final class KnowledgeQueryCore {
    ...
    public struct NeutralContextPack: Sendable {
        ...
        public let instructionHints: [String]

        public init(scopeTitle: String, promptContext: String, citations: [Citation], instructionHints: [String]) {
            self.scopeTitle = scopeTitle
            self.promptContext = promptContext
            self.citations = citations
            self.instructionHints = instructionHints
        }
    }
    ...
    public init(modelContext: ModelContext, memoryPrivacy: AskAIMemoryPrivacyConfiguration) {
    ...
    public func buildContext(for scope: ChatScope) -> NeutralContextPack {
        switch scope {
    ...
    public func fetchFileContext(fileID: UUID) -> NeutralContextPack {
    ...
    public func fetchProjectContext(projectID: UUID) -> NeutralContextPack {
    ...
    public func fetchGlobalContext() -> NeutralContextPack {
    ...
    public func makePrompt(userMessage: String, contextPack: NeutralContextPack) -> String {
    ...
    private func emptyPack(scopeTitle: String) -> NeutralContextPack {
        NeutralContextPack(
            scopeTitle: scopeTitle,
            promptContext: "",
            citations: [],
