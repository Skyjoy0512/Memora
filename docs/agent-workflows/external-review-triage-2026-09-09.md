...
| 分類 | 件数 | 該当 |
|---|---|---|
| 未対応 | 13 | R01〜R06, R09〜R11, R14〜R17 |
| 要再現（コード上リスクは確認） | 3 | R18〜R20 |
| 修正済み（2026-09-09） | 4 | R07 / R08 / R12 / R13 |
| 指摘不成立 | 0 | — |

※ R03 / R06 / R13 / R16 は「コード上は指摘どおり」だが、仕様意図・影響量・発生頻度の
確認が必要な注記つき（各項参照）。
...
残る未対応 13 件（R01〜R06 / R09〜R11 / R14〜R17）と要再現 3 件（R18〜R20）は下表のとおり。
