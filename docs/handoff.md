...
このプロジェクトは iPhone の Claude アプリから操作を承認できるように設定されています。

#### 前提条件
- Claude Code と iOS Claude アプリで同じ Anthropic アカウントを使用
- 現在の認証状態: OAuth でログイン済み

#### 承認フロー
1. Claude Code セッションを開始
2. Claude が変更を提案すると iPhone に通知
3. iOS アプリで承認・拒否を選択
4. 結果が Claude Code に反映される
