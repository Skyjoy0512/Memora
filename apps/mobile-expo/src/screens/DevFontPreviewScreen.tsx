...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.text, fontSize: typography.size.callout, fontWeight: '700' },
  loading: { alignItems: 'center', flex: 1, justifyContent: 'center' },
  pickerRow: { gap: spacing.sm, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  chip: { backgroundColor: colors.surfaceAlt, borderRadius: 0, paddingHorizontal: spacing.md, paddingVertical: spacing.xs },
  ...
  previewCard: { backgroundColor: colors.surfaceAlt, borderRadius: 0, gap: spacing.md, padding: spacing.lg },
  displaySample: { color: colors.text, fontSize: typography.size.headline, lineHeight: typography.lineHeight(typography.size.headline) },
  titleSample: { color: colors.text, fontSize: typography.size.title2, fontWeight: '700', lineHeight: typography.lineHeight(typography.size.title2) },
  bodySample: { color: colors.textSecondary, fontSize: typography.size.body, lineHeight: typography.lineHeight(typography.size.body) },
  captionSample: { color: colors.textTertiary, fontSize: typography.size.caption, lineHeight: typography.lineHeight(typography.size.caption) },
});
